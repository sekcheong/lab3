...
public class Instance {
	...
	protected enum HowCreated
	{
		Original, Rotated, Shifted, FlippedTopToBottom, FlippedLeftToRight
	};
	...
	public int[][] getGrayImage() {
		...
		if (gray_image != null) { return gray_image; }
	...
	public Instance rotateImageThisManyDegrees(double degrees) {
		...
		// See http://stackoverflow.com/questions/2278414/rotating-an-image-in-c-c
		for (int newRow = 0; newRow < this.height; ++newRow) {
			// Use the new indices so we make sure something goes into every new cell. Use -radians since we are rotating BACK to the original image.
